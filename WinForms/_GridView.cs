...
namespace sharpAHK_Dev
{
    ...
    {
        // must define grID.dvName (global grid to act on with menu actions)
        ...
        private static _Dict dict = new _Dict();
        private static _StatusBar sb = new _StatusBar();
        private static _Database.Tags tags = new _Database.Tags();
        private static _MenuControl menu = new _MenuControl();
        ...
        public static class gridSetup
        {
            ...
            //public static _SQL sql { get; set; }
            //public static _SQLite sqlite { get; set; }
            //public static _TreeViewControl tv { get; set; }
            //public static _Lists lst { get; set; }
            //public static _Dict dict { get; set; }
            //public static _StatusBar sb { get; set; }
            //public static _Tags tags { get; set; }
            //public static _MenuControl menu { get; set; }


            public static DataGridView currentGrid { get; set; }
            public static MenuStrip currentMenu { get; set; }

            public static List<int> RowHeightList { get; set; }
            public static List<int> ColumnWidthPercentages { get; set; }
        }

        // Returns Current DataGridView assigned from Form
        private DataGridView CurrentGrid()
        {
            return _GridControl.gridSetup.currentGrid;
        }
        // Returns Current DataGridView assigned from Form
        private MenuStrip CurrentMenu()
        {
            return _GridControl.gridSetup.currentMenu;
        }
        ...
        public void GridAddColumn(DataGridView dv, string ColName, string HeaderText = "")
        {
        ...
        public void Grid_Refresh(DataGridView dv)
        {
            if (dv == null) { dv = gridSetup.currentGrid; }
            if (dv != null) { gridSetup.currentGrid = dv; }
        ...
        public int SQL(DataGridView dv, SqlConnection conn, string SQLQuery, bool AddCheckBoxColumn = false)
        {
            if (dv == null) { dv = gridSetup.currentGrid; }
            if (dv != null) { gridSetup.currentGrid = dv; }
        ...
        public void HideColumn(DataGridView dv, int ColNumber)
        {
            if (dv == null) { dv = gridSetup.currentGrid; }
            if (dv != null) { gridSetup.currentGrid = dv; }
        ...
        /// <param name="dv"> </param>
        /// <param name="ColNumber"> </param>
        public void ShowColumn(DataGridView dv, int ColNumber)
        {
            if (dv == null) { dv = gridSetup.currentGrid; }
            if (dv != null) { gridSetup.currentGrid = dv; }
        ...
        /// <param name="dv"> </param>
        public int ColCount(DataGridView dv)
        {
            if (dv == null) { dv = gridSetup.currentGrid; }
            if (dv != null) { gridSetup.currentGrid = dv; }
        ...
        {
            string startTimer = "Stop";
            if (StartTimer) { startTimer = "Start"; }
            sb.StatusBar(Text, section, startTimer, stopTimer.ToString());
        }
        ...
        public void MixedColumnGrid(DataGridView dv, string cbColName = "Flag", string textColumn1 = "TextColumn1", string textColumn2 = "TextColumn2", string linkColumn = "LinkColumn", string imageColumn = "ImageColumn")
        {
            // Add New Column to GridView - CheckBox Column
            // string cbColName = "";
            DataGridViewCheckBoxColumn checkCol = new DataGridViewCheckBoxColumn();
            ...
            */
            ...
            // Add New Column to GridView - TextBox Column
            // string textColumn = "";
            DataGridViewTextBoxColumn textCol1 = new DataGridViewTextBoxColumn();
            textCol1.Name = textColumn1; // set column name
            dv.Columns.Add(textCol1);  // assign to grid


            // Add New Column to GridView - TextBox Column
            // string textColumn = "";
            DataGridViewTextBoxColumn textCol2 = new DataGridViewTextBoxColumn();
            textCol2.Name = textColumn2; // set column name
            dv.Columns.Add(textCol2);  // assign to grid
